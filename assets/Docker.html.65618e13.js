import{_ as c}from"./plugin-vue_export-helper.21dcd24c.js";import{o as l,c as o,a as n,b as e,e as i,d as s,r as t}from"./app.4ad16a80.js";const d={},r=i('<h1 id="docker\u5BB9\u5668\u6280\u672F" tabindex="-1"><a class="header-anchor" href="#docker\u5BB9\u5668\u6280\u672F" aria-hidden="true">#</a> Docker\u5BB9\u5668\u6280\u672F</h1><h2 id="\u4E00-docker-introduction" tabindex="-1"><a class="header-anchor" href="#\u4E00-docker-introduction" aria-hidden="true">#</a> \u4E00 Docker Introduction</h2><h3 id="_1-docker-install" tabindex="-1"><a class="header-anchor" href="#_1-docker-install" aria-hidden="true">#</a> 1. Docker Install</h3>',3),p=s("docker \u5B98\u7F51\u5B89\u88C5\u6559\u7A0B\uFF1A"),u={href:"https://docs.docker.com/engine/install/centos/",target:"_blank",rel:"noopener noreferrer"},v=s("https://docs.docker.com/engine/install/centos/"),m=i(`<h4 id="docker\u7684\u5FEB\u901F\u5B89\u88C5" tabindex="-1"><a class="header-anchor" href="#docker\u7684\u5FEB\u901F\u5B89\u88C5" aria-hidden="true">#</a> Docker\u7684\u5FEB\u901F\u5B89\u88C5</h4><p><strong>Uninstall old versions</strong>\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> yum remove <span class="token function">docker</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,32),x=s("\u9A8C\u8BC1\u5B89\u88C5\u662F\u5426\u6210\u529F\uFF1A\u6D4F\u89C8\u5668\u8BBF\u95EE "),y={href:"http://localhost:9200",target:"_blank",rel:"noopener noreferrer"},q=s("http://localhost:9200"),S=s(" \uFF0C\u6216\u8005\u547D\u4EE4\u884C\uFF1A"),E=n("code",null,"curl http://localhost:9200",-1),D=s(" ."),w=i(`<br><p>IK\u4E2D\u6587\u5206\u8BCD\u5668\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># \u5C06Linux \u4E2D\u7684 ik \u76EE\u5F55\u590D\u5236\u5230es\u5BB9\u5668\u4E2D</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),O=s("\u6D4F\u89C8\u5668\u4E0A\u8F93\u5165\uFF1A"),I={href:"http://localhost:5601",target:"_blank",rel:"noopener noreferrer"},R=s("http://localhost:5601"),T=s("\uFF0C\u5982\u65E0\u6CD5\u8BBF\u95EE\u8FDB\u5BB9\u5668\u68C0\u67E5\u914D\u7F6E\u662F\u5426\u751F\u6548"),A=i(`<br><h4 id="nginx\u5B89\u88C5\u4E0E\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#nginx\u5B89\u88C5\u4E0E\u914D\u7F6E" aria-hidden="true">#</a> Nginx\u5B89\u88C5\u4E0E\u914D\u7F6E</h4><p>\u521B\u5EFA\u914D\u7F6E\u6587\u4EF6\u76EE\u5F55\uFF1A</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h4 id="nacos\u5B89\u88C5\u4E0E\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#nacos\u5B89\u88C5\u4E0E\u914D\u7F6E" aria-hidden="true">#</a> nacos\u5B89\u88C5\u4E0E\u914D\u7F6E</h4>`,13),N=s("\u6CE8\u610F\u670D\u52A1\u5668\u5185\u5B58\u4E0D\u8DB3\uFF0C\u542F\u52A8\u540E\u5185\u5B58\u6EA2\u51FA\u95EE\u9898\uFF08\u5355\u673Astandalone\u6A21\u5F0F\u9ED8\u8BA4\u670D\u52A1\u5668\u5806\u5927\u5C0F512M\uFF09"),M={href:"https://nacos.io/zh-cn/docs/what-is-nacos.html",target:"_blank",rel:"noopener noreferrer"},P=s("nacos\u5B98\u65B9\u6587\u6863"),C=i(`<div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>
